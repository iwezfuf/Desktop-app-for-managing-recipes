...
public class EntityTableModelProvider {
    ...
    public EntityTableModelProvider(EntityTableModel<Recipe> recipeTableModel, EntityTableModel<Ingredient> ingredientTableModel, EntityTableModel<Unit> unitTableModel, EntityTableModel<RecipeCategory> recipeCategoryTableModel, CrudService<RecipeIngredientAmount> ingredientAmountCrudService) {
